...
[View or download sample code](https://github.com/sniperkit/iris/tree/master/_examples/websocket).
...
* import the `"github.com/sniperkit/iris/websocket"`
...
```go
import "github.com/sniperkit/iris/websocket"
```
