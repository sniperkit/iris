...
This folder provides easy to understand code snippets on how to get started with [iris](https://github.com/sniperkit/iris) micro web framework.
...
where [mvc.Result](https://github.com/sniperkit/iris/blob/master/mvc/go19.go#L10) is an [interface](https://github.com/sniperkit/iris/blob/master/hero/func_result.go#L18) which contains only that function: `Dispatch(ctx iris.Context)`.
...
iris cache library lives on its own [package](https://github.com/sniperkit/iris/tree/master/cache).
...
iris session manager lives on its own [package](https://github.com/sniperkit/iris/tree/master/sessions).
...
typescript automation tools have their own repository: [https://github.com/sniperkit/iris/tree/master/typescript](https://github.com/sniperkit/iris/tree/master/typescript) **it contains examples**

> I'd like to tell you that you can use your favourite but I don't think you will find such a thing anywhere else.

### Hey, You

Developers should read the [godocs](https://godoc.org/github.com/sniperkit/iris) and https://docs.iris-go.com for a better understanding.

Psst, I almost forgot; do not forget to [star or watch](https://github.com/sniperkit/iris/stargazers) the project in order to stay updated with the latest tech trends, it never takes more than a second!
