...
Veja o que [as pessoas estão dizendo sobre o Iris](#support) e [deixe uma estrela](https://github.com/sniperkit/iris/stargazers) nesse repositório do github para se [manter atualizado](https://facebook.com/iris.framework).
...
- Econtrou algum bug ? Poste-o nas [issues](https://github.com/sniperkit/iris/issues)
...
[Lista de todos os Contribuintes](https://github.com/sniperkit/iris/graphs/contributors)
...
- Leia os [godocs](https://godoc.org/github.com/sniperkit/iris) para mais detalhes
...
> Voce criou algo parecido ? [Informe-nos](https://github.com/sniperkit/iris/pulls)!
