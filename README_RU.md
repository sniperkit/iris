...
Узнайте, что [другие говорят об Iris](#support), и [запустите](https://github.com/sniperkit/iris/stargazers) этот github-хранилище, чтобы оставаться в курсе последних событий [актуальными](https://facebook.com/iris.framework).
...
- Вы случайно обнаружили ошибку? Опубликуйте ее на [Github вопросы](https://github.com/sniperkit/iris/issues)
...
[Список всех участников](https://github.com/sniperkit/iris/graphs/contributors)
...
- Прочтите [godocs](https://godoc.org/github.com/sniperkit/iris) для любых подробностей
...
> Вы построили что-то подобное? Дайте нам [знать](https://github.com/sniperkit/iris/pulls)!
