...
import (
	...
	"github.com/sniperkit/iris/core/maintenance"
	"github.com/sniperkit/iris/core/netutil"
	"github.com/sniperkit/iris/core/router"
	// handlerconv conversions
	"github.com/sniperkit/iris/core/handlerconv"
	// cache conversions
	"github.com/sniperkit/iris/cache"
	// view
	"github.com/sniperkit/iris/view"
	// middleware used in Default method

	requestLogger "github.com/sniperkit/iris/middleware/logger"
...
//
// Example: https://github.com/sniperkit/iris/tree/master/_examples/subdomains/redirect
...
var (
	...
	//
	//
	// Examples: https://github.com/sniperkit/iris/tree/master/_examples/file-server
	...
	//
	// Examples can be found at: https://github.com/sniperkit/iris/tree/master/_examples/#caching
	Cache = cache.Handler
	...
	// Use this, which is a shortcut of the, `chache#Cache304` instead of the "github.com/sniperkit/iris/cache" or iris.Cache
	...
	//
	// Example: https://github.com/sniperkit/iris/tree/master/_examples/cookies/securecookie
	//
...
//
// Example: https://github.com/sniperkit/iris/tree/master/_examples/file-server/single-page-application
...
// https://github.com/sniperkit/iris/blob/master/_examples/http-listening/notify-on-shutdown/main.go
